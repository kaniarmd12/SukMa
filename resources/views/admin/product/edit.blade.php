            ...
            <div class="card-body">
                ...
                <div class="card-body">
                    <div class="mb-4 row align-items-center">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="pdc_pictures_product" value="{{$product->pdc_pictures_product}}" class="form-control" id="exampleInputText1" placeholder="" required oninvalid="this.setCustomValidity('Nama Produk Wajib Diisi')" 
                        onchange="this.setCustomValidity('')">
                      </div>
                      @error('pdc_pictures_product')
                        <div>error</div>
                      @enderror
                    </div>

                    <div class="mb-4 row align-items-center">
                        <label for="exampleInputText1" class="form-label col-sm-3 col-form-label">Nama Produk</label>
                        <div class="col-sm-9">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4 row align-items-center">
                          ...
                          <div class="col-sm-9">
                              <select class="form-select mr-sm-2" id="inlineFormCustomSelect" name="ctg_category_product_id" oninvalid="this.setCustomValidity('Tingkatan Wajib Diisi')" onchange="this.setCustomValidity('')" required>
            ...
            <div class="card-body">
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="col-sm-9">
                   ...
                   <input class="form-control"  type="file" name="pdc_pictures_product" value="{{ asset('storage/'.$product->pdc_pictures_product)}}" id="formFile">
                   <div> 
                ...
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="pdc_name" class="form-control" value="{{$product->pdc_name}}" id="exampleInputText2" placeholder="" required oninvalid="this.setCustomValidity('Singkatan Wajib Diisi')" 
                    onchange="this.setCustomValidity('')">
                  </div> 
                  @error('pdc_prefix')
                    <div>error</div>
